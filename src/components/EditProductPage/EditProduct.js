        ...
        return (
            <div className="container">
                <nav className="navbar navbar-light bg-light mb-2 ">
                    <h1 className="h3 mb-0 text-gray-800">Modificar</h1>
                </nav>
                <div className="row">
                    <div className="col-6 m-auto">
                        <form onSubmit={this.handleSubmit}> 
                                ...
                                <div className="form-group">
                                    <label>Nombre</label>
                                    <input name='productName' placeholder={this.state.productName} onChange={this.handleChange} className="form-control mr-sm-2" type="text" aria-label="Search" />
                                </div>
                                
                                <div className="form-group">
                                    <label>Descripción</label>
                                    <textarea placeholder={this.state.productDescription} name="productDescription" onChange={this.handleChange} className="form-control" rows="3"></textarea>
                                </div>
                                <div className="form-group">
                                    <label>Precio</label>
